...
BOT_TOKEN = environ.get('BOT_TOKEN', "6645851482:AAEXQbwSUQ4jt79DEZTdtqABM2Pw0K1kdWk")
...
URL = "https://smdfiletolink.koyeb.app/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://smdfiletolink.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://smdfiletolink.koyeb.app/".format(FQDN)
else:
    URL = "https://smdfiletolink.koyeb.app/".format(FQDN)
